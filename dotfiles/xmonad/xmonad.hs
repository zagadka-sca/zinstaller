...
myBrowser :: String
myBrowser = "brave-browser"               -- Sets qutebrowser as browser for tree select
...
myKeys home =
    ...
    -- Run Prompt
        ...
        , ("M-S-<Return>", spawn "dmenu_run -fn \"Ubuntu Mono:bold:pixelsize=16\" -i -p \"Run: \"") -- Dmenu
    ...
    -- Workspaces
        , ("M-S-<Left>", prevScreen)  -- Switch focus to next monitor
        , ("M-S-<Right>", nextScreen)  -- Switch focus to prev monitor
        , ("M-C-<Right>", nextWS)       -- Shifts next ws
        , ("M-C-<Left>",  prevWS)  -- Shifts prev ws
...
main = do
    ...
    xmonad $ ewmh def
        ...
        , logHook = workspaceHistoryHook <+> myLogHook <+> dynamicLogWithPP xmobarPP
                        { ppOutput = \x -> hPutStrLn xmproc1 x  >> hPutStrLn xmproc1 x
