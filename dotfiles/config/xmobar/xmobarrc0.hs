...
Config { font    = "xft:Ubuntu:weight=bold:pixelsize=22:antialias=true:hinting=true"
       ...
       , sepChar = "%"
       , alignSep = "}{"
       , template = "bbb %UnsafeStdinReader% }{ <fc=#666666> | </fc><fc=#ffffff> %cpu% </fc><fc=#666666> |</fc><fc=#ffffff> %memory% </fc><fc=#666666> |</fc> <fc=#ffffff> %disku% </fc><fc=#666666> |</fc> <fc=#ffffff> %wlp0s20f3% </fc><fc=#666666> |</fc> <fc=#ffffff> %battery%  </fc> <fc=#666666> |</fc> <fc=#ffffff> %date%  </fc>"
       }
